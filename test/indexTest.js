describe('index.js', function () {
  describe('scuberGreetingForFeet()', function () {
    it('gives customers a free sample if the ride is less than or equal to 400 feet', function () { //ride <= 400;//
      expect(scuberGreetingForFeet(199)).to.equal('This one is on me!');
    });

    it('charges 20 dollars for a distance between 400 and 2000 feet', function () { //if ride > 400 && ride <= 2000 {charge = 30};//
